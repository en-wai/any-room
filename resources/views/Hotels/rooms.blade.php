                                ...
                                <div class="text p-4 p-xl-5 text-center">
                                    ...
                                    <p class="mb-0">
                                        <span class="price mr-1">
                                            {{ number_format((float) str_replace(['$', ','], '', $room->price), 2) }}
                                        </span>
                                    ...
                                    <p class="pt-1">
                                        <a href="{{ route('hotel.rooms.details', $room->id) }}" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a>
                                    </p>
                                </div>
                            </div>
                        </div>
